...
//
//     final otherLinkModel = otherLinkModelFromJson(jsonString);

import 'dart:convert';

OtherLinkModel otherLinkModelFromJson(String str) => OtherLinkModel.fromJson(json.decode(str));

String otherLinkModelToJson(OtherLinkModel data) => json.encode(data.toJson());
