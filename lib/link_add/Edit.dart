...
class _EditLinkState extends State<EditLink> {
  ...
  getCategoryId() {
    final categoryController =
        Provider.of<CategoricContrllar>(context, listen: false).catagoriclist;
    for (var i in categoryController.msg!) {
      if (widget.category == i.catName) {
        setState(() {
          category = i.catId!;
        });
      }
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      Provider.of<AddLinkControllar>(context, listen: false)
          .changTitle(widget.title);
      Provider.of<AddLinkControllar>(context, listen: false)
          .changDesc(widget.desc);
      getCategoryId();
      setState(() {
